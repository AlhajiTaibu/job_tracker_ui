import { JobApplicationResponse, JobApplication } from "@/lib/types"
...
const addJob = async (data: JobApplication) => {
...
const useAddJob = () => {
    ...
    return useMutation({
        mutationFn: (data: JobApplication) => addJob(data),
